...
This is the source code (as of August '09) for the sdbShell. The purpose of posting it here is that it access all of the functionality of SimpleDB and can provide a reference to those trying to do various things in SimpleDB with typica.
